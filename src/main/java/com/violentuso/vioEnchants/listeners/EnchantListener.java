    ...
    public void onDamage(EntityDamageByEntityEvent event) {
        ...
        if (pdc.has(CustomEnchant.VAMPIRISM.KEY, PersistentDataType.INTEGER)) {
            ...
            if (random.nextDouble() <= chance) {
                ...
                if (CustomEnchant.VAMPIRISM.ACTIVATION_SOUND != null) {
                    attacker.playSound(attacker.getLocation(), CustomEnchant.VAMPIRISM.ACTIVATION_SOUND, CustomEnchant.VAMPIRISM.ACTIVATION_SOUND_VOLUME, CustomEnchant.VAMPIRISM.ACTIVATION_SOUND_PITCH);
                }
            }
        }
        ...
        if (pdc.has(CustomEnchant.POISON.KEY, PersistentDataType.INTEGER)) {
            ...
            if (random.nextDouble() <= chance) {
                ...
                if (CustomEnchant.POISON.ACTIVATION_SOUND != null) {
                    attacker.playSound(attacker.getLocation(), CustomEnchant.POISON.ACTIVATION_SOUND, CustomEnchant.POISON.ACTIVATION_SOUND_VOLUME, CustomEnchant.POISON.ACTIVATION_SOUND_PITCH);
                }
            }
        }
